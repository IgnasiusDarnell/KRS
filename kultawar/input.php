                    ...
                    <div class="form-group">
                        ...
                        <select id="npp" name="npp" class="form-control" required>
                            ...
                            while ($row = $dosen->fetch_assoc()) {
                                echo "<option value='{$row['npp']}'>{$row['namadosen']}</option>";
                            }
                            ?>
                        </select>
                    </div>
        ...
        $(document).ready(function() {
            $("#saveBtn").click(function() {
                ...
                $.post("proses.php", formData, function(response) {
                    alert(response.message); // Menampilkan pesan response
                    if (response.message.includes("berhasil")) {
                        window.location.href = "index.php"; // Redirect ke halaman tabel
                    } else {
